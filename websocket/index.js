...
module.exports = function() {
	...
	module.chat = function(ws) {
		...
		ws.on('message', function (message){
			ws.send(getRandomSupportResponse(supportAgent));
		});
	}
	...
	function getRandomSupportResponse(agentName) {
		var supportResponses = ["One moment please...", 
		...
		return JSON.stringify({"agent" : agentName,
			"message" : supportResponses[getRandomInt(0,supportResponses.length)]});
	}
